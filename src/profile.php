...
<?php else : ?>
    ...
    <?php flash() ?>
    <form method="post" action="do_login.php" style="width: 600px;display: flex;flex-direction: column;gap: 20px;align-items: center; margin: 20px auto">
        <div class="mb-3">
